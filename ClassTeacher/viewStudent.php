...
// Fetch only currently enrolled (active) courses taken by the student
$coursesQuery = "SELECT c.course_name 
                 FROM tblcoursetaken ct 
                 JOIN tblcourse c ON ct.course_id = c.course_id 
                 WHERE ct.std_id = ? AND ct.isActive = 1";
...
<body>
    ...
    <div class="container">
        ...
        <?php else: ?>
            <p>No currently enrolled courses.</p>
        <?php endif; ?>
